...
<template>
  <q-page>    
          ...
          <div class="col-xs-5 col-sm-6 col-md-6">
            <q-card-section class="texto1">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/col.svg" style="width: 40px; height: 20px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
                  <span class="text-h3" style="white-space: initial;">Bogotá</span>
                </q-item-section>
              </q-item>                
            </q-card-section>
            <q-card-section style="margin-top:-15px;" class="texto3">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/marcador.svg" style="width: 40px; height: 40px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
            ...
            <q-card-section style="margin-top:-20px;" class="texto3">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/mensaje.svg" style="width: 40px; height: 40px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
            ...
            <q-card-section style="margin-top:-20px;" class="texto3">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/llamada.svg" style="width: 40px; height: 40px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
            ...
            <q-card-section style="margin-top:-20px;" class="texto3">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/whatsapp.svg" style="width: 40px; height: 40px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
          ...
          <div class="col-xs-5 col-sm-6 col-md-6">
            <q-card-section class="texto1">
              <q-item>
                <q-item-section side>
                  <q-avatar>
                    <q-img src="../statics/pro/cad.svg" style="width: 40px; height: 20px;"></q-img>
                  </q-avatar>
                </q-item-section>
                <q-item-section>
    ...
    <div class="bg-negative row justify-center q-mt-xl">
      <div class="text-center">
        <q-card-section class="col-gutter-xs col-xs-12 col-sm-12 col-md-2 q-mt-sm q-mb-sm">
          <img src="../statics/pro/logo.png" class="" style="height: 60px;"/>
        </q-card-section>
      </div>
      <q-separator style="width:2px; height:35px; margin-top:30px;" class="xs-hide" color="white" vertical inset />
      <div>
        <q-card-section class="texto3 text-center text-h6 col-gutter-xs col-xs-12 col-sm-12 col-md-3 q-mb-md" style="margin-top:20px;">
